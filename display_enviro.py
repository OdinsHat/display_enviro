...
class ZeroWEnvironment:
    ...
    def show_gas(self):
        """Show analog gas readings for MQ135 and MQ9
        MQ135 is air quality and MQ9 is carbon monoxide
        """
        ...
        self.lcd.write("CO = {:f}".format(mq9))
        self.lcd.set_cursor_position(0, 1)
    ...
    def show_environment(self):
        ...
        self.prepare_lcd()
        self.lcd.write("CO2: {:.3f} PPM".format(self.ccs811.eco2))
        self.lcd.set_cursor_position(0, 1)
        self.lcd.write("TVOC: {:.3f} PPM".format(self.ccs811.tvoc))
        self.lcd.set_cursor_position(0, 2)
        self.lcd.write("Temp: {:.1f} C".format(self.ccs811.temperature))

    def show_light(self):
        """Show the light sensor readings from the Envirophat"""
        self.backlight.set_graph(0.6)
        rgb = self.light.rgb()
        self.prepare_lcd()
        self.lcd.write("Light Level: {:.3f}".format(self.light.light()))
        self.lcd.set_cursor_position(0, 2)
